...
namespace DepartmentRating
{
    public class Startup
    {
        ...
        {
            DepartmentRatingDAL.Models.Options.ActiveDirectoryOptions.DomainName = Configuration["ConfigDomain:domainName"];
            DepartmentRatingDAL.Models.Options.ActiveDirectoryOptions.AccessGroupName = Configuration["ConfigDomain:accessGroup"];
        }
